...
class rfService():
    ...
    def callResourceURI(self, URILink):
        ...
        print("scheme={}, netloc={}, path={}, params={}, query={}, fragment={}".format(scheme, netloc, path, params, query, fragment))
        ...
        if 'extrajsonheaders' in config and not isXML:
            print("config_json: ", config['extrajsonheaders'])
            ExtraHeaders = config['extrajsonheaders']
        elif 'extraxmlheaders' in config and isXML:
            print("config_xml: ", config['extraxmlheaders'])
