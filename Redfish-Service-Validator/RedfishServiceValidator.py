...
def validateSingleURI(URI, uriName='', expectedType=None, expectedSchema=None, expectedJson=None, parent=None):
    ...
    try:
        ...
        if results[uriName]['payload'] is not None:
            ...
            if __debug__:
                print("### successPayload: ", successPayload)
                print("### odataMessages: ", odataMessages)
        ...
        if __debug__:
            print("### PropResourceObj: ",propResourceObj)
    ...
    print("result[warns]: ", results[uriName]['warns'])
    print("result[errors]: ", results[uriName]['errors'])
...
def validateURITree(URI, uriName, expectedType=None, expectedSchema=None, expectedJson=None, parent=None, allLinks=None):
    ...
    print("URI={}, uriName={}, expectedType={}, expectedSchema={}, expectedJson={}, parent={} ".format(URI, uriName, expectedType, expectedSchema, expectedJson, parent) )
...
def main(direct_parser=None):
	
    args = arg_setting(None)
